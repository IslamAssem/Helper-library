...
class OnItemClickListener<T : Any?, V : View?>  {
    ...
    @CallSuper
    fun onItemClick(t: T, v: V, position: Int) {
        onItemClick()
        onItemClick(t)
        onItemClick(v)
    ...
    @CallSuper
    fun onItemClick(t: T, type: ClickType?, position: Int) {
        onItemClick()
        onItemClick(t)
        onItemClick(position)
        onItemClick(t, position)
    ...
    fun onItemClick(t: T, clickType: ClickType?) {}
}
