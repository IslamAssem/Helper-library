...
abstract class BaseFragment : Fragment() {
    ...
    private lateinit var messagesHandler: MessagesHandler
    ...
    override fun onAttach(context: Context) {
        ...
        if (!::messagesHandler.isInitialized) {
            messagesHandler = if (context is BaseActivity)
    ...
    override fun onAttach(activity: Activity) {
        ...
        lifecycleObserver.onAttach()
        if (!::messagesHandler.isInitialized) {
            messagesHandler = if (activity is BaseActivity)
    ...
    final override fun onCreateView(
        ...
        return inflate(getLayoutId(),container,inflater,context)
    }
